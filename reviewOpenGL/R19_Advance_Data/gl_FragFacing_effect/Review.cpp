...
int main()
{
    ...
    // Create Textrues
    // ---------------
    unsigned int frontTexture = loadTexture("img/container.jpg");
    unsigned int backTexture = loadTexture("img/matrix.jpg");
    ...
    cubeShader.use();
    cubeShader.setInt("frontTexture", 0);
    cubeShader.setInt("backTexture", 1);
