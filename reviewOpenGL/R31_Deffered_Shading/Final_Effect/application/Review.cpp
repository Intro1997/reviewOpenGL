...
int main()
{
    ...
    // Get model
    // ---------
    Model nanosuit = Model("Model/nanosuit/nanosuit.obj");

    // build and compile shaders
    // -------------------------
    ReviewShader gBufferShader("shader/gBuffer.vs", "shader/gBuffer.fs");
    ReviewShader quadShader("shader/quadShader.vs", "shader/quadShader.fs");
    ReviewShader lightingPassShader("shader/lightingPass.vs", "shader/lightingPass.fs");
    ReviewShader shaderLightBox("shader/light.vs", "shader/light.fs");
    ...
    if(glCheckFramebufferStatus(GL_FRAMEBUFFER) != GL_FRAMEBUFFER_COMPLETE){
        cout << "Framebuffer Object isn't complete!" << endl;
    }
    glBindFramebuffer(GL_FRAMEBUFFER, 0);
    
    // define positions of the models
    // -----------------------------
