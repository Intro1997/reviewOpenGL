...
private:
    ...
    Mesh processMesh(aiMesh *mesh, const aiScene *scene){
        ...
        vector<Texture> texture_normal = loadMaterialTexture(material, aiTextureType_HEIGHT, "texture_normal");
        textures.insert(textures.end(), texture_normal.begin(), texture_normal.end());
